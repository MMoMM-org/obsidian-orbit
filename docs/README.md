...
Documentation for **Orbital** — *see what orbits your notes.*
...
- [Settings reference](settings-reference.md) — each setting in depth: effect and when
  to change it.
- [Commands reference](commands-reference.md) — the commands Orbital adds to the palette.
...
- **Tuning Orbital?** See the [Settings reference](settings-reference.md).
